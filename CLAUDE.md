...
- `src/features/game/map/GameMapPage.tsx` — RPG stage map. Stage unlock is sequential: Level N requires Level N−1 cleared. Cleared stages show ✓; locked ones show a disabled span. Currently 9 stages (Lv1–9).
